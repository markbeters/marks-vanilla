...
namespace MarksVanilla.Common.GlobalItems
{
	...
	// 
	public class GrayZapinatorChanges : GlobalItem
	{
		// Only instancing this for Gray Zapinator item
		public override bool AppliesToEntity(Item item, bool lateInstantiation) {
			return item.type == ItemID.ZapinatorGray; // grab the int id for Gray Zapinator
		}
