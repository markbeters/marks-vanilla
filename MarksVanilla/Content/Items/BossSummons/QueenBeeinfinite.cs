...
{
    public class QueenBeeinfinite : ModItem
    {
        ...
        public override bool CanUseItem(Player player) {
			...
			// EoC is summonable in night time and if one does not already exist
			return !Main.LocalPlayer.ZoneJungle && !NPC.AnyNPCs(NPCID.QueenBee);
		}
        ...
        public override void AddRecipes() { //use chaining method to add the recipe for this item
			CreateRecipe()
				.AddIngredient(ItemID.Abeemination, 10)
