...
{
    public class Goleminfinite : ModItem
    {

        public override void SetStaticDefaults() {
			Item.ResearchUnlockCount = 1; // only 1 needed to research in journey mode
			ItemID.Sets.SortingPriorityBossSpawns[Type] = 16; // This helps sort inventory know that this is a boss summon item
        ...
        public override bool CanUseItem(Player player) {
			...
			// Golem only summonable at altar (how to do this??) and if one does not already exist
        ...
        public override void AddRecipes() { //use chaining method to add the recipe for this item
			CreateRecipe()
				.AddIngredient(ItemID.LihzahrdPowerCell, 10)
