...
{
    public class Destroyerinfinite : ModItem
    {
        ...
        public override bool CanUseItem(Player player) {
			...
			// Destroyer is summonable in night time and in hardmode, extra provisions for zenith seed
			return !Main.IsItDay() && !NPC.AnyNPCs(NPCID.TheDestroyer) && Main.hardMode && !(Main.remixWorld && Main.getGoodWorld);
		}
