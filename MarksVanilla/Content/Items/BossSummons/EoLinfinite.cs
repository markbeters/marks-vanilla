...
{
    public class EoLinfinite : ModItem
    {
        ...
        public override bool CanUseItem(Player player) {
			...
			// Empress of Light only summonable if one does not already exist
        ...
        public override void AddRecipes() { //use chaining method to add the recipe for this item
			CreateRecipe()
				.AddIngredient(ItemID.EmpressButterfly, 15) //this should be replaced with a custom item that drops upon breaking bulbs
