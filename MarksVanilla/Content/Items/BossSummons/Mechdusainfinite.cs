...
{
    public class Mechdusainfinite : ModItem
    {
        ...
        public override bool CanUseItem(Player player) {
			...
			// Skeletron Prime is summonable in night time and in hardmode, extra provisions for zenith seed
			return !NPC.AnyNPCs(NPCID.SkeletronPrime) && !NPC.AnyNPCs(NPCID.Spazmatism) && !NPC.AnyNPCs(NPCID.Retinazer) && !NPC.AnyNPCs(NPCID.TheDestroyer) && Main.hardMode && (Main.remixWorld && Main.getGoodWorld) ;
		}
        ...
        public override void AddRecipes() { //use chaining method to add the recipe for this item
			CreateRecipe()
				.AddIngredient(ItemID.MechanicalSkull, 5)
				.AddIngredient(ItemID.MechanicalWorm, 5)
				.AddIngredient(ItemID.MechanicalEye, 5)
