...
{
    public class Twinsinfinite : ModItem
    {
        ...
        public override bool CanUseItem(Player player) {
			...
			// Twins are summonable in night time and in hardmode, extra provisions for zenith seed
			return !Main.IsItDay() && !NPC.AnyNPCs(NPCID.Spazmatism) && !NPC.AnyNPCs(NPCID.Retinazer) && Main.hardMode && !(Main.remixWorld && Main.getGoodWorld);
		}
        ...
        public override bool? UseItem(Player player) {
			if (player.whoAmI == Main.myPlayer) {
				...
				// we have to spawn both of the twins
