...
namespace MarksVanilla.Content.Projectiles
{
	public class AmethystBullet : ModProjectile
	{
		...
		public override bool OnTileCollide(Vector2 oldVelocity) {
			...
			Dust dust = Dust.NewDustDirect(Projectile.position + Projectile.velocity * Main.rand.Next(6, 10) * 0.15f, Projectile.width, Projectile.height, DustID.GemAmethyst, 0f, 0f, 80, Color.White, 1f);
			dust.position.X -= 4f;
